"""Точка входа FastAPI-приложения notification_api."""
...
async def validation_error_handler(
    ...
    ошибок с остальными сервисами проекта. Срабатывает только на уровне
    самого HTTP-биндинга (например, тело запроса не JSON), т.к. заявки на
    /api/v1/notifications принимаются как dict и валидируются бизнес-логикой
    (§2 контракта)."""
    first = exc.errors()[0]
